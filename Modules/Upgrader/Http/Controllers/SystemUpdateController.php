...
class SystemUpdateController extends Controller
{
    ...
    {
        $itemCode = config('martvill.item_code');
        $version = martvillVersion();
        $apiEndpoint = config('martvill.server_url ') . "/api/v1/version/check/{$itemCode}/{$version}"; // Replace with the API endpoint
        $newVersion = $version;
    ...
    {
        $itemCode =  config('martvill.item_code');
        $apiEndpoint = config('martvill.server_url ') . "/api/v1/version/download"; // Replace with the API endpoint
