                                                                ...
                                                                <div class="col-7">
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="simple_product"
                                                                            ...
                                                                            {{ isset($setting['simple_product']) && $setting['simple_product'] == 1 ? 'checked' : '' }}>
                                                                        <label class="cr"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="grouped_product"
                                                                            ...
                                                                            {{ isset($setting['grouped_product']) && $setting['grouped_product'] == 1 ? 'checked' : '' }}>
                                                                        <label class="cr"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="affiliate_product"
                                                                            ...
                                                                            {{ isset($setting['affiliate_product']) && $setting['affiliate_product'] == 1 ? 'checked' : '' }}>
                                                                        <label class="cr"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <input type="checkbox" name="variable_product"
                                                                            ...
                                                                            {{ isset($setting['variable_product']) && $setting['variable_product'] == 1 ? 'checked' : '' }}>
                                                                        <label class="cr"
                                                                    ...
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        ...
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox" name="taxes"
                                                                                id="taxes" value="1"
                                                                                {{ isset($setting['taxes']) && $setting['taxes'] == 1 ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        ...
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox" name="coupons"
                                                                                ...
                                                                                value="1"
                                                                                {{ isset($setting['coupons']) && $setting['coupons'] == 1 ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        ...
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox" name="calculate_coupon"
                                                                                ...
                                                                                {{ isset($setting['calculate_coupon']) && $setting['calculate_coupon'] == 1 ? 'checked' : '' }}>
                                                                            <label for="calculate_coupon"
                                                                                class="cr"></label>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <select class="form-control select2-hide-search"
                                                                        ...
                                                                        <option value="kg"
                                                                            {{ isset($setting['measurement_weight']) && $setting['measurement_weight'] == 'kg' ? 'selected' : '' }}>
                                                                            kg</option>
                                                                        <option value="g"
                                                                            {{ isset($setting['measurement_weight']) && $setting['measurement_weight'] == 'g' ? 'selected' : '' }}>
                                                                            g</option>
                                                                        <option value="lbs"
                                                                            {{ isset($setting['measurement_weight']) && $setting['measurement_weight'] == 'lbs' ? 'selected' : '' }}>
                                                                            lbs</option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-4">
                                                                    ...
                                                                    <select class="form-control select2-hide-search"
                                                                        ...
                                                                        <option value="m"
                                                                            {{ isset($setting['measurement_dimension']) && $setting['measurement_dimension'] == 'm' ? 'selected' : '' }}>
                                                                            m</option>
                                                                        <option value="cm"
                                                                            {{ isset($setting['measurement_dimension']) && $setting['measurement_dimension'] == 'cm' ? 'selected' : '' }}>
                                                                            cm</option>
                                                                        <option value="mm"
                                                                            {{ isset($setting['measurement_dimension']) && $setting['measurement_dimension'] == 'mm' ? 'selected' : '' }}>
                                                                            mm</option>
                                                                        <option value="inch"
                                                                            {{ isset($setting['measurement_dimension']) && $setting['measurement_dimension'] == 'inch' ? 'selected' : '' }}>
                                                                            inch</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        ...
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox"
                                                                                ...
                                                                                value="1"
                                                                                {{ isset($setting['reviews_enable_product_review']) && $setting['reviews_enable_product_review'] == 1 ? 'checked' : '' }}>
                                                                        ...
                                                                        <div class="ltr:me-3 rtl:ms-3">
                                                                            ...
                                                                            <div class="switch switch-bg d-inline m-r-10">
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    value="1"
                                                                                    {{ isset($setting['reviews_verified_owner_label']) && $setting['reviews_verified_owner_label'] == 1 ? 'checked' : '' }}>
                                                                        ...
                                                                        <div class="ltr:me-3 rtl:ms-3">
                                                                            ...
                                                                            <div class="switch switch-bg d-inline m-r-10">
                                                                                <input type="checkbox" name="review_left"
                                                                                    ...
                                                                                    {{ isset($setting['review_left']) && $setting['review_left'] == 1 ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        ...
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox" name="rating_enable"
                                                                                ...
                                                                                value="1"
                                                                                {{ isset($setting['rating_enable']) && $setting['rating_enable'] == 1 ? 'checked' : '' }}>
                                                                        ...
                                                                        <div class="ltr:me-3 rtl:ms-3">
                                                                            ...
                                                                            <div class="switch switch-bg d-inline m-r-10">
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    {{ isset($setting['rating_required']) && $setting['rating_required'] == 1 ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        ...
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox" name="wishlist"
                                                                                ...
                                                                                value="1"
                                                                                {{ isset($setting['wishlist']) && $setting['wishlist'] == 1 ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        ...
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox" name="compare"
                                                                                ...
                                                                                value="1"
                                                                                {{ isset($setting['compare']) && $setting['compare'] == 1 ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        ...
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox" name="manage_stock"
                                                                                ...
                                                                                value="1"
                                                                                {{ isset($setting['manage_stock']) && $setting['manage_stock'] == 1 ? 'checked' : '' }}>
                                                                            <label for="manage_stock"
                                                                                class="cr"></label>
                                                                        </div>
                                                                    </div>
                                                                ...
                                                                <div class="col-9">
                                                                    <div class="col-4 pl-0">
                                                                        <input type="number"
                                                                            ...
                                                                            min="0"
                                                                            value="{{ isset($setting['hold_stock']) ? $setting['hold_stock'] : 0 }}">
                                                                    </div>
                                                                    <div class="mt-2">
                                                                    ...
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        ...
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox"
                                                                                ...
                                                                                {{ isset($setting['notification_low_stock']) && $setting['notification_low_stock'] == 1 ? 'checked' : '' }}>
                                                                        ...
                                                                        <div class="ltr:me-3 rtl:ms-3">
                                                                            ...
                                                                            <div class="switch switch-bg d-inline m-r-10">
                                                                                <input type="checkbox"
                                                                                    ...
                                                                                    value="1"
                                                                                    {{ isset($setting['notification_out_of_stock']) && $setting['notification_out_of_stock'] == 1 ? 'checked' : '' }}>
                                                                ...
                                                                <div class="col-sm-1">
                                                                    ...
                                                                    <div class="switch switch-bg d-inline m-r-10">
                                                                        <input type="checkbox" name="stock_threshold"
                                                                            ...
                                                                            {{ isset($setting['stock_threshold']) && $setting['stock_threshold'] == 1 ? 'checked' : '' }}>
                                                                        <label for="stock_threshold"
                                                                            class="cr"></label>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        ...
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox"
                                                                                ...
                                                                                value="1"
                                                                                {{ isset($setting['out_of_stock_visibility']) && $setting['out_of_stock_visibility'] == 1 ? 'checked' : '' }}>
                                                                            <label for="out_of_stock_visibility"
                                                                                class="cr"></label>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="col-sm-12 mb-2">
                                                                            <div class="mb-2 radio radio-warning d-inline">
                                                                                <input type="radio" id="always_show"
                                                                                    ...
                                                                                    {{ !isset($setting['stock_display_format']) ? 'checked' : '' }}
                                                                                    value="always_show"
                                                                    ...
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        ...
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox"
                                                                                ...
                                                                                {{ isset($setting['is_publish_product']) && $setting['is_publish_product'] == 1 ? 'checked' : '' }}>
                                                                            <label for="is_publish_product"
                                                                                class="cr"></label>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        ...
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox" name="chat"
                                                                                ...
                                                                                value="1"
                                                                                {{ isset($setting['chat']) && $setting['chat'] == 1 ? 'checked' : '' }}>
                                                                    ...
                                                                    <div class="ltr:me-3 rtl:ms-3">
                                                                        ...
                                                                        <div class="switch switch-bg d-inline m-r-10">
                                                                            <input type="checkbox" name="is_vendor_customer_list_active"
                                                                                ...
                                                                                value="1"
                                                                                {{ isset($setting['is_vendor_customer_list_active']) && $setting['is_vendor_customer_list_active'] == 1 ? 'checked' : '' }}>
